...
public class LodgeMap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent() != null) {
            ...
            if(viewType.equals("assets")) {
                mPDFView.fromAsset("Lodge_Map.pdf")
                        ...
                        .onPageError(new OnPageErrorListener() {
                            ...
                            public void onPageError(int page, Throwable t) {
                                Toast.makeText(LodgeMap.this, "Error while opening page " + page, Toast.LENGTH_SHORT).show();
                            }
                        })
